        ...
        var dt_report = datatables_report.DataTable({
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function (data: any, type: any, full: { [x: string]: any; }, meta: any) {
                ...
                var $row_output =
                  ...
                  '<div class="avatar-xs">' +
                  '<div style="padding:7px" class="avatar-title rounded-circle bg-' + $state + '-subtle text-' + $state + '">' +
                  $initti +
                  '</div>' +
                  '</div>' +
            ...
            },
            {
              ...
              render: function (data: any, type: any, full: { [x: string]: any; }, meta: any) {
                 return `<div class="d-flex align-items-center">
                            <i class="icon-base ti ti-sm tabler-mail icon-sm me-1_5 text-secondary"></i>
                            <span>`+data+`</span>
                        </div>`
            ...
            },
            {
              ...
              render: function (data: any, type: any, full: { [x: string]: any; }, meta: any) {
                return `<div class="d-flex align-items-center">
                         <i class="icon-base ti ti-sm tabler-phone icon-sm me-1_5 text-secondary"></i>
                         <span>`+data+`</span>
                        </div>`
              }
            },
            {
              ...
              render: function (data: any, type: any, full: { [x: string]: any; }, meta: any) {
                return `<div class="d-flex align-items-center">
                        <i class="icon-base ti ti-sm tabler-world icon-sm me-1_5 text-secondary"></i>
                        <span>`+data+`</span>
                      </div>`
              }
            },
